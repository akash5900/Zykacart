    ...
    <div className=" flex items-center justify-center px-3 ">
      <div className=" border rounded-[10px] shadow-md border-black min-h-[470px] w-[335px] md:w-[400px] flex flex-col items-center justify-center gap-[20px] mt-[50px] px-4 md:px-[20px] py-[10px] ">
        ...
        <div className="relative w-[400px]">
          <input
            className="border border-pink-800 w-[300px] md:w-[400px] pl-8 md:pl-0 rounded-[8px] bg-pink-50 px-3 py-2"
          ...
          <span
            ...
            className="absolute right-5 md:right-3 top-2 md:top-3 cursor-pointer text-pink-800"
          >
